...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	public String clickButton(String xpathKey){
		...
		try{
			...
			//Changes made by Ankit Rastogi >>> && xpathKey.indexOf(':')== 5
			else if((xpathKey.startsWith("name"))&&((xpathKey.contains(":")))&& xpathKey.indexOf(':')==5) 
			{
				String[] xpathKey2 =  xpathKey1[1].split(":");
	...
	public  String CheckBox(String xpathKey)
	{
		...
		JavascriptLibrary jsLib = new JavascriptLibrary(); 
		WebElement element = null;
		boolean checkstatus;//Ankit 11/7
		JavascriptExecutor js = (JavascriptExecutor) driver;
		String result = "Fail";
		...
		try{
			...
			else if((xpathKey.startsWith("id"))&&((xpathKey.contains(">"))))
			{
				...
				js.executeScript("arguments[0].setAttribute('style', arguments[1]);", element, "background:  skyblue; border: 2px red;color: black");
				try{
				checkstatus=element.isSelected();//AR Added this if checkbox already checked and no need to uncheck it
				...
				if(checkstatus == true){
					...
					element.click();
					//System.out.println("Checkbox was not checked so we check it");
					}
					result = "Pass";
				}
				catch (Exception e) {
